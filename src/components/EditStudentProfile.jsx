...
import { editStudent, getAStudent } from "../libs/studentsAPI";
...
const EditStudentForm = () => {
      ...
      if (
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            try {
              setLoading(true);
              const res = await editStudent(id, values);

              setLoading(false);
              if (res.ok) {
                showSuccess("Student Information Updated");
                navigate(-1);
              } else {
  ...
  useEffect(() => {
    formik.setValues({
      name_en: student && student?.name_en,
      name_bn: student && student?.name_bn,
      gender: student && student?.gender,
      classe: student && student?.classe,
      class_role: student && student?.class_role,
      section: student && student?.section,
      father_name: student && student?.personal_information?.father_name,
      mother_name: student && student?.personal_information?.mother_name,
      village1:
        student && student?.personal_information?.present_address?.village1,
      post1: student && student?.personal_information?.present_address?.post1,
      upazilla1:
        student && student?.personal_information?.present_address?.upazilla1,
      district1:
        student && student?.personal_information?.present_address?.district1,
      village2:
        student && student?.personal_information?.permanent_address?.village2,
      post2: student && student?.personal_information?.permanent_address?.post2,
      upazilla2:
        student && student?.personal_information?.permanent_address?.upazilla2,
      district2:
        student && student?.personal_information?.permanent_address?.district2,
      contact_no: student && student?.personal_information?.contact_no,
      dob: student && student?.dob,
      nid: student && student?.personal_information?.nid,
      image: student && student?.image,
      religion: student && student?.personal_information?.religion,
      nationality: student && student?.personal_information?.nationality,
      blood_group: student && student?.personal_information?.blood_group,
      occupation: student && student?.personal_information?.occupation,
      marital_status: student && student?.personal_information?.marital_status,
      email: student && student?.email,
    });
    setImgUrl(student && student?.image);
  }, [student]);
