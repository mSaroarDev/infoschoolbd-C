...
import { editTeacher, getATeacher } from "../libs/teacherAPI";
...
export default function EditProfileForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      setLoading(true)
      const res = await editTeacher(id, values)
      setLoading(false)
      if(res.ok){
        showSuccess("Teacher Updated");
        navigate("/user/teachers?page=1")
      } else {
        showError("Teacher update failed")
      }
    },
  });
      ...
      >
        <div className="grid grid-cols-12 gap-3">
          ...
          <div className="col-span-12 md:col-span-4 flex flex-col gap-1">
            <label className="text-[15px] italic">অফিসিয়াল পদবী (বাংলায় যেমনঃ প্রধান শিক্ষক) <span className="text-red-600">*</span></label>
            <input
              type="text"
              id="designation"
              name="designation"
