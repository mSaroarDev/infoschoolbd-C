...
export default function ListOfficeStaffs() {
  // utils
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Staffs || infoSchoolBD</title>
      </Helmet>
      ...
      <div className="flex items-center justify-between">
        ...
        />
        <Link to="/user/staffs/create" className="button-dark font-bold">
      ...
      <div className="messages_box mt-5">
        <div className="relative overflow-x-auto">
          ...
          data &&
          data.map((teacher) => (
            <StaffCard key={teacher?._id} data={teacher} />
          ))
        )}
            </tbody>
          </table>
