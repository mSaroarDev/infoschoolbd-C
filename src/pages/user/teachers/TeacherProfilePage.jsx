...
import { deleteTeacher, getATeacher } from "../../../libs/teacherAPI";
...
export default function TeacherProfilePage() {
  ...
  const fetchData = async () => {
    setLoading(true);
    const res = await getATeacher(id);
  ...
  const handleDelete = async () => {
    ...
    setLoading(false);
    if (res.ok) {
      showSuccess("Teacher profile Deleted");
      navigate("/user/teachers?page=1");
    } else {
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <PageHeader
              text="শিক্ষক প্রোফাইল"
              icon={<CircleUserRound className="w-5 h-5" />}
            />

            <div className="flex items-center gap-1">
              <Link to={`/user/teachers/edit/${id}`} className="button-dark">
                এডিট
              </Link>
              <button
          ...
          <div className="mt-10 mb-20 md:mb-0">
            <div className="grid grid-cols-12 gap-5">
              <div className="col-span-12 md:col-span-3 flex flex-col items-center justify-start w-full">
                <div className="h-[150px] w-[150px] rounded-full ring-2 ring-blue-600 object-cover overflow-hidden">
                  <img
                ...
                <div className="w-full mt-5 flex flex-col items-center font-semibold">
                  <h2 className="bg-blue-600/10 text-black px-4 py-2 rounded text-center w-fit">
                    {data?.name_bn}
                  </h2>
                </div>
              </div>
              <div className="col-span-12 md:col-span-9">
                ...
                <div className="grid grid-cols-12 gap-5 mt-10">
                  ...
                  />
                  <ProfileInfoField text="পদবী" value={data?.designation} />
                  <ProfileInfoField
                    text="যোগদানের তারিখ"
