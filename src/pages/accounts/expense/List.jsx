...
export default function ExpenseistPage() {
  ...
  const fetchData = async () => {
    try {
      const res = await getMyExpense(page, 200);
      if (res.ok) {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        ...
        <Link to="/accounts/expense/create" className="button-main">
          New Expense
        </Link>
      </div>
