...
import { getAllSchoolsInstall } from "../../../libs/schoolAPI";
import { getBaseUrl } from "../../../utils/getBaseUrl";

export default function CreateDeveloperID() {
  ...
  const getAllSchool = async () => {
    const res = await getAllSchoolsInstall(1, 0);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        setLoading(true);
        const res = await fetch(apiUrl + "/install/create-user", {
          method: "POST",
          headers: {
